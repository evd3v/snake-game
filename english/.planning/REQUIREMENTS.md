...
- [x] **ANAL-01**: Клик на предложение открывает модалку с AI-анализом (перевод, слова с POS, грамматика, коллокации)
- [x] **ANAL-02**: Повторный клик на уже проанализированное предложение подгружает результат из БД без AI-запроса
- [x] **ANAL-03**: В модалке показаны только НОВЫЕ слова (отсутствующие в словаре или с новым POS) с кнопками "учить"/"знаю"
- [x] **ANAL-04**: Коллокации и грамматические конструкции также показаны с кнопками "учить"/"знаю"
